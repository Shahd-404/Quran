-- Migration: replace ensure_current_reading_assignment with fully qualified column references
-- Timestamped: 2026-07-26T20:00:00
...
BEGIN
  ...
  SELECT da.id, da.local_date, da.target_pages, (SELECT count(*) FROM public.reading_sessions AS rs WHERE rs.daily_assignment_id = da.id)
  INTO v_assignment_id, v_local_date, v_assigned, v_sessions_to_use
  FROM public.daily_assignments AS da
